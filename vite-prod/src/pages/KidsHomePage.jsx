...
const GAME_CARDS = [
  ...
  },
  {
    id: 'life-coach',
    emoji: '💬',
    titleHe: 'ספרו לספיקלי!',
    titleEn: "Tell Speakli!",
    titleAr: 'أخبر سبيكلي!',
    titleRu: 'Расскажи Спикли!',
  ...
  },
  {
    ...
    titleAr: 'تدريب النطق',
    titleRu: 'Тренировка произношения',
    descHe: 'תרגלו לדבר באנגלית',
    descEn: 'Practice speaking English',
    descAr: 'تدرب على الكلام بالإنجليزية',
  ...
  },
  {
    id: 'conversation',
    emoji: '🗣️',
    titleHe: 'שיחות באנגלית',
    titleEn: "English Conversations",
    titleAr: 'محادثات بالإنجليزية',
    titleRu: 'Английские разговоры',
    descHe: 'תרגלו שיחות עם ספיקלי',
    descEn: 'Practice conversations with Speakli',
    descAr: 'تدرب على المحادثات مع سبيكلي',
    descRu: 'Практикуй разговоры со Спикли',
