...
const GAME_CARDS = [
  ...
  },
  {
    id: 'space-flight',
    emoji: '🚀',
    titleHe: 'טיסה בחלל עם ספיקלי!',
    titleEn: "Speakli's Space Flight!",
    titleAr: 'رحلة سبيكلي الفضائية!',
    titleRu: 'Космический полёт Спикли!',
    descHe: 'טוסו בחלל ואספו מילים!',
    descEn: 'Fly through space & learn words!',
    descAr: 'طيروا في الفضاء وتعلموا!',
    descRu: 'Летай в космосе и учи слова!',
