...
export default function LessonPage({ lesson, onComplete, onBack }) {
  ...
  const exercises = lesson?.exercises || [
    { type: 'multiple-choice', question: 'What is the English word for "שלום"?', questionHe: 'מהי המילה באנגלית ל-"שלום"?', questionAr: 'ما الكلمة الإنجليزية لـ "مرحبا"؟', questionRu: 'Как по-английски "привет"?', options: ['Hello', 'Goodbye', 'Please', 'Thank you'], correct: 0, explanation: ({ he: '"Hello" = שלום. זוהי הברכה הנפוצה ביותר באנגלית.', ar: '"Hello" = مرحبا. هي التحية الأكثر شيوعاً بالإنجليزية.', ru: '"Hello" = привет. Самое распространённое приветствие в английском.', en: '"Hello" means greeting - the most common English greeting.' })[uiLang] || '"Hello" - the most common English greeting.' },
    { type: 'fill-blank', sentence: 'Nice to ___ you.', answer: 'meet', hint: ({ he: 'ברכה כשפוגשים מישהו חדש (נעים להכיר)', ar: 'تحية عند مقابلة شخص جديد (سعيد بلقائك)', ru: 'Приветствие при знакомстве (приятно познакомиться)', en: 'A greeting when meeting someone new' })[uiLang] || 'A greeting when meeting someone new', alternatives: ['meet'] },
    { type: 'word-arrange', words: ['are', 'How', 'you', '?'], correct: 'How are you ?', translation: 'מה שלומך?', translationAr: 'كيف حالك؟', translationRu: 'Как дела?' },
    { type: 'translation', source: ({ he: 'תודה רבה', ar: 'شكراً جزيلاً', ru: 'Большое спасибо', en: 'Thank you very much' })[uiLang] || 'תודה רבה', target: 'Thank you very much', alternatives: ['Thanks a lot', 'Thank you so much'] },
    { type: 'match-pairs', pairs: [['Hello', lf({ translation: 'שלום', translationAr: 'مرحبا', translationRu: 'привет' }, 'translation', uiLang)], ['Goodbye', lf({ translation: 'להתראות', translationAr: 'مع السلامة', translationRu: 'до свидания' }, 'translation', uiLang)], ['Please', lf({ translation: 'בבקשה', translationAr: 'من فضلك', translationRu: 'пожалуйста' }, 'translation', uiLang)], ['Thank you', lf({ translation: 'תודה', translationAr: 'شكراً', translationRu: 'спасибо' }, 'translation', uiLang)]] },
    { type: 'multiple-choice', question: 'Choose the correct greeting for the morning:', questionHe: 'בחרו את הברכה הנכונה לבוקר:', questionAr: 'اختاروا التحية الصحيحة للصباح:', questionRu: 'Выберите правильное утреннее приветствие:', options: ['Good morning', 'Good evening', 'Good night', 'Goodbye'], correct: 0, explanation: ({ he: 'Good morning = בוקר טוב. משתמשים בברכה הזו עד הצהריים.', ar: 'Good morning = صباح الخير. تُستخدم حتى الظهر.', ru: 'Good morning = доброе утро. Используется до полудня.', en: 'Good morning is used until around noon.' })[uiLang] || 'Good morning is used until around noon.' },
    { type: 'fill-blank', sentence: 'My ___ is David.', answer: 'name', hint: ({ he: 'כשמציגים את עצמנו - "השם שלי הוא..."', ar: 'عند تقديم النفس - "اسمي هو..."', ru: 'Когда представляешься - "Меня зовут..."', en: 'When introducing yourself - "My ... is"' })[uiLang] || 'When introducing yourself - "My ... is"' },
